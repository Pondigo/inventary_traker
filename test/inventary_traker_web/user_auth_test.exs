defmodule InventaryTrakerWeb.UserAuthTest do
  use InventaryTrakerWeb.ConnCase, async: true

  alias InventaryTraker.Accounts
  alias InventaryTraker.Accounts.Scope
  alias InventaryTrakerWeb.UserAuth

  import InventaryTraker.AccountsFixtures

  @remember_me_cookie "_inventary_traker_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, InventaryTrakerWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
